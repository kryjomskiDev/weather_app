...
// in weather_app/test/unit_tests/data/interceptors/api_key_interceptor_test.dart.
...
import 'package:weather_app/config/envs.dart' as _i7;
...
/// A class which mocks [Envs].
///
/// See the documentation for Mockito's code generation for more information.
class MockEnvs extends _i1.Mock implements _i7.Envs {
  MockEnvs() {
    _i1.throwOnMissingStub(this);
  }
